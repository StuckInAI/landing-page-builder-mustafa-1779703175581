  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-white pt-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
        ...
        {/* Heroes of Lumina section */}
        <div className="mt-24 text-center animate-fade-up">
          <div className="inline-flex items-center gap-2 bg-[#ede9ff] text-[#6c63ff] text-xs font-semibold px-3 py-1.5 rounded-full mb-4">
            <span className="w-1.5 h-1.5 rounded-full bg-[#6c63ff] animate-pulse" />
            Meet the team
          </div>
          ...
          <p className="text-gray-500 max-w-xl mx-auto mb-10">
            The brilliant minds behind Lumina — building tools that empower teams worldwide.
          </p>

          {/* Photo placeholder — swap src with actual uploaded image URL */}
          <div className="relative mx-auto max-w-3xl rounded-2xl overflow-hidden shadow-2xl border border-gray-100">
            <img
              src="https://placehold.co/900x500/ede9ff/6c63ff?text=Heroes+of+Lumina"
              alt="Heroes of Lumina"
